...
from src.api.routes import audio, audio_segments, cases, characters, checkpoints, edl, logs, pipeline, profiles, research, scripts, steps, topics, uploads
...
app.include_router(audio_segments.router, prefix="/api")
